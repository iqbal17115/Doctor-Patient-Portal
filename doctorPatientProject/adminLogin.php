	...
	<style>
		body{
	       ...
	       background-size: cover;
			...
			width: 270px;
			height: 250px;
			background-color: rgba(25, 200, 255, .4);
			margin: 100px auto;
...
<form action="aLoginValidation.php" method="POST">
		<div class="box">
		...
		<span class="pl-5 text-white">Not yet register!! <a class="text-warning" href="adminReg.php">register</a></span>
	</div>
</form>
	</div>
